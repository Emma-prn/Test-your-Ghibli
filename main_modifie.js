...
function getNewQuestion(){
    ...
    for (let i = 0; i < ansLen; i++) {
      ...
      /// on pourrait mettre un eventlistener ?
...
//! J'ai vu qu'il ne fallait pas mettre de try-catch dans des endroits où le fail corrompt
//! l'état du programme. Si il y a un fail à ces endroits, il faut tout stopper
//! et demander à l'utilisateur de relancer l'application.
//!
//! On va donc laisser l'erreur se propager (si il y en a une) et la catch a la
//! fin (dans le .catch() en bas du fichier)
...
//! Si jamais l'init a fail, alors le jeu est potentiellement injouable, autant
//! demander a l'utilisateur de reload la page en l'envoyant sur l'ecran
//! d'erreur
.catch(
    function(e) {
        console.log(e);
